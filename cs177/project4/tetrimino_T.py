...
class Tetrimino_T( Tetrimino ):
    # TASK 4:
    #
    # Constructor function of Tetrimino_T.
    ...
    #
    # Please see images/initial_tetrimino_T_01.png,
    #            images/initial_tetrimino_T_02.png,
    #            images/initial_tetrimino_T_03.png,
    #            images/initial_tetrimino_T_04.png
    #
    ...
    def __init__( self, tetris_window  ):
        ...
        x = ( num_x // 2) * bs + bs // 2
        y = bs // 2
        self.coordinates = [ (x-bs,y),(x,y),(x+bs,y),(x,y+bs) ]
    ...
    #
    # Tetrimino_T has four states. (0,1,2 and 3)
    # 
    ...
    # 
    # Please see  images/tetrimino_T_01_state_00.png
    #             images/tetrimino_T_01_state_01.png
    #             images/tetrimino_T_01_state_02.png
    #             images/tetrimino_T_01_state_03.png
    #             images/tetrimino_T_02_state_00.png
    #             images/tetrimino_T_02_state_01.png
    #             images/tetrimino_T_02_state_02.png
    #             images/tetrimino_T_02_state_03.png
    # 
    # and their corresponding parameters in images/data.txt
    #
    # (Tetrimino_I and Tetrimino_J is given to you. Please look at them before you
    ...
    def rotate( self ):
        ...
        if self.state == 0:
            ...
            temp = [ (x,y-bs),(x,y),(x,y+bs),(x-bs,y) ]
        elif self.state == 1:
            x,y = self.coordinates[1]
            temp = [ (x-bs,y),(x,y),(x+bs,y),(x,y-bs) ]
        elif self.state == 2:
            x,y = self.coordinates[1]
            temp = [ (x,y-bs),(x,y),(x,y+bs),(x+bs,y) ]
        elif self.state == 3:
