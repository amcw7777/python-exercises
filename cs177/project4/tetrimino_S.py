...
class Tetrimino_S( Tetrimino ):
    # TASK 3:
    #
    # Constructor function of Tetrimino_S.
    ...
    #
    # Please see images/initial_tetrimino_S_01.png,
    #            images/initial_tetrimino_S_02.png,
    #            images/initial_tetrimino_S_03.png,
    #            images/initial_tetrimino_S_04.png
    #
    ...
    #
    # Tetrimino_S has two states. (0 and 1)
    # 
    ...
    # 
    # Please see  images/tetrimino_S_01_state_00.png
    #             images/tetrimino_S_01_state_01.png
    #             images/tetrimino_S_02_state_00.png
    #             images/tetrimino_S_02_state_01.png
    # 
    # and their corresponding parameters in images/data.txt
    #
    # (Tetrimino_I and Tetrimino_J is given to you. Please look at them before you
